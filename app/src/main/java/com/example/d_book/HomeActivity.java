...
public class HomeActivity extends AppCompatActivity {
    ...
    private void setupBanner() {
        ...
        bannerData.add(new Banner(R.drawable.banner_winter, "겨울 감성으로 책과 함께"));
        bannerData.add(new Banner(R.drawable.banner_magic, "마법 같은 모험을 시작해요"));
        bannerData.add(new Banner(R.drawable.banner_letter, "편지처럼 마음을 전해요"));
                ...
                db.collection("bookReviews")
                        ...
                        .addSnapshotListener((reviewSnapshots, ex) -> {
                            ...
                            for (DocumentSnapshot r : reviewSnapshots.getDocuments()) {
                                ...
                                if (parent != null && !parent.isEmpty()) replyCount++;
                            }
    ...
    private void setupDots(LinearLayout container, int count) {
        ...
        for (int i = 0; i < count; i++) {
            android.view.View dot = getLayoutInflater().inflate(R.layout.tab_dot, container, false);
            dot.setSelected(i == 0);
